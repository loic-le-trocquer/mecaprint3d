export const defaultContent = {
  ...
  hero: {
    ...
    description:
      "MecaPrint3D accompagne particuliers et professionnels pour la réparation de pièces cassées, la restauration de véhicules, les prototypes et les objets personnalisés.",
