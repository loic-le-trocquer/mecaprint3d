      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="mt-20 grid gap-8 md:grid-cols-3">
          {items.map((item, index) => (
            <article
              key={index}
              className="group relative overflow-hidden rounded-3xl border border-white/10 bg-zinc-900/70 backdrop-blur-xl transition duration-500 hover:-translate-y-2 hover:border-orange-500/40"
            >
              {/* IMAGE */}
