export default function TechnologiesIntro({
  ...
  return (
    <div className="relative z-10 mb-16 max-w-5xl">
      ...
      <p className="mb-3 text-sm font-semibold uppercase tracking-[0.3em] text-orange-500">
        {intro.eyebrow || "Expertise matériaux"}
      </p>
  ...
  {intro.description ||
    "Une pièce performante ne dépend pas uniquement de sa forme. Le choix du matériau et de la technologie de fabrication est essentiel pour répondre aux contraintes mécaniques, thermiques, chimiques et esthétiques."}
</p>
...
>
  🔬 Comparer et choisir son matériau
</button>
